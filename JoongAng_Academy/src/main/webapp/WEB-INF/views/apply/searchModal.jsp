	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="d-flex justify-content-center mb-2">
					<div class="row"
						...
						<div class="col-9 mr-1 mt-3">
							<input type="text" class="form-control form-control-sm" id="searchNM2" >
						</div>
						...
						<div class="col-9 ">
							<div class="input-group" style="margin-top: -5px;">
								...
								<input type="text" class="form-control form-control-sm"
									style="border-radius: 5px 0 0 5px;" value="2023">

								<select class="form-select form-select-sm" style="border-radius: 0 5px 5px 0;">
									<option>상반기</option>
									<option>하반기</option>
								</select>
							</div>
				...
				<div id="stuList" class="mb-3 mt-3" style="width: 100%; height:430px;" ></div>
			</div>
		</div>
	</div>
</div>
