		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<h6 class="mt-2 pt-1 fw-bolder">개설강좌</h6>
					<div id="grid" class="mb-3 mt-3" style="width: 100%; background-color: gray; height:250px;" ></div>
					<div class="float-start"
						style="width: 10px; height: 29px; background-color: #498c5f; margin-right: 10px;"></div>
					<h6 class="mt-2 pt-1 fw-bolder">신청강좌</h6>
					<div id="grid" class="mb-3 mt-3" style="width: 100%; background-color: gray; height:250px;" ></div>
