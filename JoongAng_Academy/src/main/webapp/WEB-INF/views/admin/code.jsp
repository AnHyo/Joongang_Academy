		...
		<main>
			<div class="container-fluid px-4">
				...
				<div style="float: left;">
					<h6 class="mt-3 fw-bolder">코드구분</h6>
				</div>
				<div class="d-flex justify-content-end pb-1 mb-2 mt-2">
					...
					<div class="input-group"
						...
						<input class="form-control form-control-sm" type="text"
							name="code_search" id="code_search" placeholder="검색어를 입력하세요"
					...
					<div>
						...
						<button type="button" class="btn btn-secondary btn-sm"
							id="add_btn1">신규</button>
						<button type="button" class="btn btn-secondary btn-sm"
							id="del_btn1">삭제</button>
						<button type="button" class="btn btn-secondary btn-sm"
							id="save_btn1">저장</button>
					</div>
				</div>
				<div>
					<div id="grid"></div>
				...
				<div style="float: left;">
					<h6 class="mt-3 fw-bolder">코드정보</h6>
				</div>
				<div class="d-flex justify-content-end pb-1 mb-2 mt-2">
					<div>
						<button type="button" class="btn btn-secondary btn-sm"
							id="add_btn2">신규</button>
						<button type="button" class="btn btn-secondary btn-sm"
							id="del_btn2">삭제</button>
						<button type="button" class="btn btn-secondary btn-sm"
							id="save_btn2">저장</button>
					</div>
				</div>
				<div>
					<div id="grid2"></div>
