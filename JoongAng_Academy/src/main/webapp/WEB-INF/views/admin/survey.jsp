						...
						<div
							...
							<div class="input-group "
								...
								<input class="form-control form-control-sm s_SBJCT_NM"
									type="text" placeholder="과목명"
									aria-describedby="btnNavbarSearch" style="margin-left: 10px;" />
							</div>
						...
						<div class="mb-5 inputTotal">
							<div class="tab-content" id="nav-tabContent">
								<div class="tab-pane fade show active" id="tab1" role="tabpanel"
									...
									<!--기본정보 -->
									<div style="width: 100%; background-color: #F3FAFE; height: 420px; border: 1px solid #e9ecef;">
										<table
